...
### O Hanger é uma ferramenta gráfica de orquestração de processos e qualidade de dados, responsável pela execução dos processos de [https://pt.wikipedia.org/wiki/Extract,_transform,_load](ETL), controle de dependências e validação dos dados.
...
##### CONSTRUÇÃO
Utilizando o [https://maven.apache.org/](Maven):
...
##### DEPLOY
Utilizando o [http://tomcat.apache.org/](Apache Tomcat):
...
- Informe a senha ou [https://stackoverflow.com/questions/45466090/how-to-get-the-api-token-for-jenkins](token) do usuário no campo **Token**.
...
## Jobs
Jobs são referencias para jobs do [https://jenkins.io/](Jenkins).
