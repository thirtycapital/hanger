...
if (!window['google']['loader']) {
    ...
    (function () {
        ...
        var w = function (a, b) {
            if (b)
                a = a.replace(n, "&amp;").replace(p, "&lt;").replace(q, "&gt;").replace(r, "&quot;").replace(t, "&#39;").replace(u, "&#0;");
            else {
                if (!v.test(a))
                    return a;
                -1 != a.indexOf("&") && (a = a.replace(n, "&amp;"));
                -1 != a.indexOf("<") && (a = a.replace(p, "&lt;"));
                -1 != a.indexOf(">") && (a = a.replace(q, "&gt;"));
                -1 != a.indexOf('"') && (a = a.replace(r, "&quot;"));
                -1 != a.indexOf("'") && (a = a.replace(t, "&#39;"));
                -1 != a.indexOf("\x00") && (a = a.replace(u, "&#0;"))
            }
            return a
        }, n = /&/g, p = /</g, q = />/g, r = /"/g, t = /'/g, u = /\x00/g, v = /[\x00&<>"']/;
        var x = /^[\w+/_-]+[=]{0,2}$/;
        function y(a) {
            return a in z ? z[a] : z[a] = -1 != navigator.userAgent.toLowerCase().indexOf(a)
        }
        var z = {};
        function A(a, b) {
            var c = function () {};
        ...
        function E(a, b) {
            a = a.split(/\./);
            for (var c = window, d = 0; d < a.length - 1; d++)
                c[a[d]] || (c[a[d]] = {}), c = c[a[d]];
            c[a[a.length - 1]] = b
        }
        function F(a, b, c) {
        ...
        google.load = function (a, b, c) {
            ...
            if (a = G[":" + e]) {
                ...
                if ((f = c && null != c.callback) && !a.D(b))
                    throw D("Module: '" + e + "' must be loaded before DOM onLoad!");
                f ? a.u(b, c) ? window.setTimeout(c.callback, 0) : a.load(b, c) : a.u(b, c) || a.load(b, c)
            } else
                throw D("Module: '" + e + "' not found!");
        };
        l("google.load", google.load);
        google.ca = function (a, b) {
            b ? (0 == I.length && (J(window, "load", K), !y("msie") && !y("safari") && !y("konqueror") && y("mozilla") || window.opera ? window.addEventListener("DOMContentLoaded", K, !1) : y("msie") ? document.write("<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (y("safari") || y("konqueror")) && window.setTimeout(L, 10)), I.push(a)) : J(window, "load", a)
        };
        ...
        google.loader.W = function () {
            ...
            "complete" == a.readyState && (a.onreadystatechange = null, a.parentNode.removeChild(a), K())
        };
        l("google.loader.domReady", google.loader.W);
        var N = {loaded: !0, complete: !0};
        function L() {
            N[document.readyState] ? K() : 0 < I.length && window.setTimeout(L, 10)
        }
        function K() {
        ...
        google.loader.f = function (a, b, c) {
            a:{
                var d = g.document;
                if ((d = d.querySelector && d.querySelector("script[nonce]")) && (d = d.nonce || d.getAttribute("nonce")) && x.test(d))
                    break a;
                d = void 0
            }
            if (c) {
                if ("script" == a) {
                    ...
                    "css" == a && (e = document.createElement("link"), e.type = "text/css", e.href = b, e.rel = "stylesheet");
                (a = document.getElementsByTagName("head")[0]) || (a = document.body.parentNode.appendChild(document.createElement("head")));
                a.appendChild(e)
            } else
                "script" == a ? (e = '<script src="' + w(b) + '" type="text/javascript"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + ">\x3c/script>")) : "css" == a && (e = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"', d && (e += ' nonce="' + w(d) + '"'), document.write(e + "></link>"))
        };
        ...
        google.loader.ba = function (a) {
            for (var b in a)
                "string" == typeof b && b && ":" == b.charAt(0) && !G[b] && (G[b] = new O(b.substring(1), a[b]))
        };
        ...
        google.loader.aa = function (a) {
            if ((a = a.specs) && a.length)
                for (var b = 0; b < a.length; ++b) {
                    var c = a[b];
                    "string" == typeof c ? G[":" + c] = new P(c) : (c = new Q(c.name, c.baseSpec, c.customSpecs), G[":" + c.name] = c)
                }
        };
        ...
        E("google_exportSymbol", E);
        E("google_exportProperty", F);
        google.loader.a = {};
        l("google.loader.themes", google.loader.a);
        google.loader.a.K = "//www.google.com/cse/static/style/look/bubblegum.css";
        m(google.loader.a, "BUBBLEGUM", google.loader.a.K);
        google.loader.a.M = "//www.google.com/cse/static/style/look/greensky.css";
        m(google.loader.a, "GREENSKY", google.loader.a.M);
        google.loader.a.L = "//www.google.com/cse/static/style/look/espresso.css";
        m(google.loader.a, "ESPRESSO", google.loader.a.L);
        google.loader.a.O = "//www.google.com/cse/static/style/look/shiny.css";
        m(google.loader.a, "SHINY", google.loader.a.O);
        google.loader.a.N = "//www.google.com/cse/static/style/look/minimalist.css";
        m(google.loader.a, "MINIMALIST", google.loader.a.N);
        google.loader.a.P = "//www.google.com/cse/static/style/look/v2/default.css";
        ...
        P.prototype.i = function (a, b) {
            ...
            if (!this.s) {
                ...
                for (d in this.l)
                    ":" == d.charAt(0) && this.l[d] && b.push(d.substring(1));
        ...
        P.prototype.H = function (a) {
            ...
            if (b)
                if ("string" == typeof b)
                    ...
                    for (c = [], a = 0; a < b.length; a++)
                        "string" == typeof b[a] && c.push(b[a].replace(/^\s*|\s*$/, "").toLowerCase());
            c || (c = ["default"]);
            b = [];
            for (a = 0; a < c.length; a++)
                this.A[":" + c[a]] || b.push(c[a]);
            return b
        };
        P.prototype.load = function (a, b) {
            var c = this.H(b), d = b && null != b.callback;
            if (d)
                var e = new R(b.callback);
            ...
            if (c.length) {
                ...
                for (h = 0; h < f.length; h++)
                    k = f[h], this.g[":" + k] = [], d && this.g[":" + k].push(e);
                if (b || null == H[":" + this.b] || null == H[":" + this.b].versions[":" + a] || google.loader.AdditionalParams || !this.s)
                    b && b.autoloaded || google.loader.f("script", this.i(a,
                            b), d);
                else {
                    a = H[":" + this.b];
                    google[this.b] = google[this.b] || {};
                    for (var B in a.properties)
                        B && ":" == B.charAt(0) && (google[this.b][B.substring(1)] = a.properties[B]);
                    google.loader.f("script", google.loader.ServiceBase + a.path + a.js, d);
                    a.css && google.loader.f("css", google.loader.ServiceBase + a.path + a.css, d)
                }
        ...
        function Q(a, b, c) {
            ...
            this.G = this.j = !1;
            this.m = [];
            google.loader.F[this.name] = C(this.o, this)
        }
        A(Q, P);
        ...
        Q.prototype.X = function (a, b, c) {
            ...
            if (null != c)
                for (var e in c)
                    a.params[e] ? d += "&" + T(a.params[e], c[e]) : "other_params" == e ? d += "&" + c[e] : "base_domain" == e && (b = "http://" + c[e] + a.uri.substring(a.uri.indexOf("/", 7)));
            google[this.name] = {};
        ...
        O.prototype.i = function (a, b) {
            if (!this.h.versions[":" + a]) {
                ...
                if (!this.h.versions[":" + a])
                    throw D("Module: '" + this.b + "' with version '" + a + "' not found!");
            }
        ...
        var U = !1, V = [], aa = (new Date).getTime(), X = function () {
            U || (J(window, "unload", W), U = !0)
        }, Z = function (a, b) {
            X();
            if (!(google.loader.Secure || google.loader.Options && !1 !== google.loader.Options.csi)) {
                for (var c = 0; c < a.length; c++)
                    a[c] = encodeURIComponent(a[c].toLowerCase().replace(/[^a-z0-9_.]+/g, "_"));
                for (c = 0; c < b.length; c++)
                    b[c] = encodeURIComponent(b[c].toLowerCase().replace(/[^a-z0-9_.]+/g, "_"));
                window.setTimeout(C(Y, null, "//gg.google.com/csi?s=uds&v=2&action=" + a.join(",") + "&it=" + b.join(",")), 1E4)
            }
        }, S = function (a,
                b, c) {
            ...
            if (V.length) {
                ...
                Y(a + "/stats?" + V.join("&") + "&nc=" + (new Date).getTime() + "_" + ((new Date).getTime() - aa));
                V.length = 0
            }
        }, Y = function (a) {
            var b = new Image, c = Y.Z++;
            Y.J[c] = b;
        ...
        Y.J = {};
        Y.Z = 0;
        E("google.loader.recordCsiStat", Z);
        E("google.loader.recordStat", S);
        E("google.loader.createImageForLogging", Y);
    ...
    google.loader.rfm({":search": {"versions": {":1": "1", ":1.0": "1"}, "path": "/api/search/1.0/ddc80d38c7e2cb7b462cb57d9710fb58/", "js": "default+pt_BR.I.js", "css": "default+pt_BR.css", "properties": {":Version": "1.0", ":NoOldNames": false, ":JSHash": "ddc80d38c7e2cb7b462cb57d9710fb58"}}, ":language": {"versions": {":1": "1", ":1.0": "1"}, "path": "/api/language/1.0/777c339fbf96071a10c88d71b8d19085/", "js": "default+pt_BR.I.js", "properties": {":Version": "1.0", ":JSHash": "777c339fbf96071a10c88d71b8d19085"}}, ":annotations": {"versions": {":1": "1", ":1.0": "1"}, "path": "/api/annotations/1.0/3b0f18d6e7bf8cf053640179ef6d98d1/", "js": "default+pt_BR.I.js", "properties": {":Version": "1.0", ":JSHash": "3b0f18d6e7bf8cf053640179ef6d98d1"}}, ":wave": {"versions": {":1": "1", ":1.0": "1"}, "path": "/api/wave/1.0/3b6f7573ff78da6602dda5e09c9025bf/", "js": "default.I.js", "properties": {":Version": "1.0", ":JSHash": "3b6f7573ff78da6602dda5e09c9025bf"}}, ":picker": {"versions": {":1": "1", ":1.0": "1"}, "path": "/api/picker/1.0/1c635e91b9d0c082c660a42091913907/", "js": "default.I.js", "css": "default.css", "properties": {":Version": "1.0", ":JSHash": "1c635e91b9d0c082c660a42091913907"}}, ":ima": {"versions": {":3": "1", ":3.0": "1"}, "path": "/api/ima/3.0/28a914332232c9a8ac0ae8da68b1006e/", "js": "default.I.js", "properties": {":Version": "3.0", ":JSHash": "28a914332232c9a8ac0ae8da68b1006e"}}});
...
google.load("visualization", "1", {"autoloaded": true, "packages": ["timeline"]});
if (window['google'] != undefined && window['google']['loader'] != undefined) {
    if (!window['google']['visualization']) {
        window['google']['visualization'] = {};
        google.visualization.Version = '1.0';
        google.visualization.JSHash = '40ff64b1d9d6b3213524485974f36cc0';
        google.visualization.LoadArgs = 'file\x3dvisualization\x26v\x3d1\x26packages\x3dtimeline';
    }
    google.loader.writeLoadTag("css", google.loader.ServiceBase + "/api/visualization/1.0/40ff64b1d9d6b3213524485974f36cc0/ui+pt_BR.css", false);
    google.loader.writeLoadTag("script", google.loader.ServiceBase + "/api/visualization/1.0/40ff64b1d9d6b3213524485974f36cc0/dygraph,format+pt_BR,default+pt_BR,ui+pt_BR,timeline+pt_BR.I.js", false);
}